...
from schemas import Car, CreateCar, UpdateCar, PaginatedCarInfo
...
class Cars:
    ...
    @router.post("/cars")
    def add_car(self, car_info: CreateCar):
...
def update_car(car_id: int, new_info: UpdateCar, session: Session = Depends(get_db)):
